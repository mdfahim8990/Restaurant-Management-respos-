...
public class AllActiverOrdersFragment extends Fragment {

    private DataBaseHelper dataBaseHelper;
    ProgressBar progressBar;
    TextView textView;
    public AllActiverOrdersFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_all_activer_orders, container, false);
        progressBar = rootView.findViewById(R.id.loadingAllActiver);
        textView = rootView.findViewById(R.id.all_activer);
